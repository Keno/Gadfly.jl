...
function display(x::TextDisplay, p::Plot)
    if default_plot_format == :png
        display(x,"image/png",p)
    elseif default_plot_format == :svg
        display(x,"image/svg+xml",p)
    elseif default_plot_format == :html
        display(x,"text/html",p)
    elseif default_plot_format == :ps
        display(x,"application/postscript",p)
    elseif default_plot_format == :pdf
        display(x,"application/pdf",p)
    else
...
function display(d::TextDisplay, ::MIME"image/png", p::Plot)
...
function display(d::TextDisplay, ::MIME"image/svg+xml", p::Plot)
...
function display(d::TextDisplay, ::MIME"image/html", p::Plot)
...
function display(d::TextDisplay, ::MIME"application/postscript", p::Plot)
...
function display(d::TextDisplay, ::MIME"application/pdf", p::Plot)
